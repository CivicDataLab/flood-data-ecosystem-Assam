...
def process_geojson(input_data, output_dir=r"D:\CivicDataLab_IDS-DRR\IDS-DRR_Github\Deployment\flood-data-ecosystem-Assam\Sources\WORLDPOP\data copy\shapefiles\district_geojson"):
    """
...
def main():
    try:
        process_geojson(
            r'D:\CivicDataLab_IDS-DRR\IDS-DRR_Github\Deployment\flood-data-ecosystem-Assam\Maps\Geojson\assam_rc_2024-11_reduced.json')
