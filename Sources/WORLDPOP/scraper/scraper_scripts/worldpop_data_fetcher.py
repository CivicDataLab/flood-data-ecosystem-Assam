...
class WorldPopDataFetcher:
    def __init__(self, base_url="https://api.worldpop.org/v1"):
        ...
        self.output_dir = Path(r"D:\CivicDataLab_IDS-DRR\IDS-DRR_Github\Deployment\flood-data-ecosystem-Assam\Sources\WORLDPOP\data\agesexstructure") / str(year)
...
def main():
    ...
    geojson_dir = Path(
        r"D:\CivicDataLab_IDS-DRR\IDS-DRR_Github\Deployment\flood-data-ecosystem-Assam\Sources\WORLDPOP\scraper\shapefiles\district_geojson")
