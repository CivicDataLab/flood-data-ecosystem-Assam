...
ASSAM_RCS = gpd.read_file(os.getcwd()+r'/IDS-DRR-Assam/Maps/Assam_Revenue_Circles/assam_revenue_circle_nov2022.geojson', driver='GeoJSON')

RC_HQs = list(ASSAM_RCS[ASSAM_RCS.HQ=='y']['revenue_ci'])

idea_frm_tenders_df  = pd.read_csv(os.getcwd()+r'/IDS-DRR-Assam/Sources/TENDERS/data/floodtenders_districtgeotagged.csv', keep_default_na=False)
...
MASTER_DF.to_csv(os.getcwd()+r'/IDS-DRR-Assam/Sources/TENDERS/data/floodtenders_RCgeotagged.csv')