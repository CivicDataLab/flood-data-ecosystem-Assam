...
assam_rc = gpd.read_file('Maps/Geojson/assam_rc_2024-11.geojson')

date_range = pd.date_range(start="2021-04-01", end="2026-07-31", freq='MS')
...
master_df.to_csv(os.getcwd() + '/Sources/MASTER_VARIABLES.csv', index=False)
